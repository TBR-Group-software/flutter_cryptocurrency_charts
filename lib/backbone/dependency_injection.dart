...
import 'package:clean_app/assembly/entity/coin_info_from_dto.dart';
...
import 'package:clean_app/assembly/entity/searched_coin_dto.dart';
import 'package:clean_app/assembly/factory.dart';
import 'package:clean_app/assembly/model/coin_dto_from_json.dart';
import 'package:clean_app/assembly/model/coin_info_dto_from_json.dart';
...
import 'package:clean_app/assembly/model/searched_coin_dto_from_json.dart';
...
void init() {
  ...
  sl.registerLazySingleton<Factory<CoinInfo, CoinInfoDto>>(
      () => CoinInfoFromDtoFactory());
  sl.registerLazySingleton<Factory<SearchedCoin, SearchedCoinDto>>(
      () => SearchedCoinFromDtoFactory());
  ...
  sl.registerLazySingleton<Factory<SearchedCoinDto, Map<String, dynamic>>>(
      () => SearchedCoinDtoFromJsonFactory());
  ...
  sl.registerLazySingleton<Factory<CoinInfoDto, Map<String, dynamic>>>(
      () => CoinInfoDtoFromJsonFactory());
  //Gateway
  sl.registerLazySingleton<RestGateway>(
      () => RestGateway(sl.get(), sl.get(), sl.get(), sl.get()));
  sl.registerLazySingleton<SettingsGateway>(() => SettingsGateway());

  //Service
  sl.registerLazySingleton<CoinService>(
      () => RestCoinService(sl.get(), sl.get(), sl.get(), sl.get()));
  ...
  sl.registerLazySingleton<GetSearchedCoinsUseCase>(
      () => RestGetSearchedCoinsUseCase(sl.get()));
  sl.registerLazySingleton<GetTrendingCoinsUseCase>(
      () => RestGetTrendingCoinsUseCase(sl.get()));
  sl.registerLazySingleton<GetMarketCoinInfoUseCase>(
      () => RestGetMarketCoinInfoUseCase(sl.get()));
  //Bloc
  ...
  sl.registerLazySingleton<CoinInfoBloc>(() => CoinInfoBloc(sl.get()));
}
